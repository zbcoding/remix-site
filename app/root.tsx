      ...
      <header className="remix-app__header">
        <div className="container remix-app__header-content">
          <Link prefetch="intent" to="/" title="Remix" className="remix-app__header-home-link">
            <span className="title-text">Developer Site</span>
          </Link>
          <nav aria-label="Main navigation" className="remix-app__header-nav">
            <ul>
              ...
              <li>
                <Link prefetch="intent" to="/posts">My Projects</Link>
              </li>
              <li>
                <Link prefetch="intent" to="/admin">Admin</Link>
              </li>
              <li>
...
function GetCurrentYear() {
  ...
  return <span className="footer-current-year">{year}</span>
}
